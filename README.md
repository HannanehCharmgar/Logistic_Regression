...
|---------------------------|----------------------------------------------|
| 📁[**SRC**](https://github.com/HannanehCharmgar/Logistic_Regression/blob/main/SRC)                | فایل اصلی                                      |
| - [`src.py`](https://github.com/HannanehCharmgar/Logistic_Regression/blob/main/SRC/src.py)                 | کد اصلی                                       |
| - [`Code&Output.ipynb`](https://github.com/HannanehCharmgar/Logistic_Regression/blob/main/SRC/Code%26Output.ipynb)       | کد و خروجی ها                                 |
|                           |                                              |
